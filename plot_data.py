...
def precomputed_smaller_benchmarkset():
    ...
    plot_data(benchmarks, data, ['V4', 'IT', 'Behaviour', 'Imagenet'], 'models')


def plot_data(benchmarks, data, labels, name):
    # res, ax = plt.subplots()
    y = np.array([0, 1, 2])
...
def plot_data_map(data, name, label_field='layer', x_name='', y_name=''):
