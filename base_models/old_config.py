...
from transformations.transformation_utils import do_distribution_weight_init, \
    ...
    do_best_dist_init_layer, do_in_channel_jumbler, do_in_kernel_jumbler, do_dist_in_layer, \
    do_poisson_layer, \
...
trained_models = {
    ...
    # Round 6 & 7
    'CORnet-S_train_gabor_dist_kernel_weight_dist_channel_second_forth': {
        'model_func': apply_generic,
        'layers': ['V2.conv1',
                   'V2.conv2',
                   'V2.conv3',
                   'V4', 'IT',
    ...
    'CORnet-S_train_kn1_kn2_kn3_kn4_kn5_kn6_bi_v2': {'model_func': apply_generic,
                                                     'layers': ['V2.conv3', 'V4', 'IT',
                                                                "decoder"],
                                                     'V1.conv1': do_kernel_normal_distribution_init,
                                                     'V1.conv2': do_kernel_normal_distribution_init,
    ...
    'CORnet-S_train_kn1_kn2_kn3_kn4_kn5_kn6_bi_full': {'model_func': apply_generic,
                                                       'layers': ['V2.conv3', 'V4', 'IT',
                                                                  "decoder"],
                                                       'V1.conv1': do_kernel_normal_distribution_init,
                                                       'V1.conv2': do_kernel_normal_distribution_init,
    ...
    'CORnet-S_train_kn1_kn2_kn3_kn4_kn5_kn6_kn7_bima': {'model_func': apply_generic,
                                                        'layers': ['V4', 'IT',
                                                                   "decoder"],
                                                        'V1.conv1': do_kernel_normal_distribution_init,
                                                        'V1.conv2': do_kernel_normal_distribution_init,
                                                        ...
                                                        'V2.conv3': do_kernel_normal_distribution_init,
                                                        'batchnorm': True,
                                                        'bn_init': do_batch_from_image_init
                                                        },
    ...
    'CORnet-S_brain2_kn8_kn9_kn10_kn11_kn12_bi_full': {
        'layers': ['IT', 'decoder'],
        'V4.conv_input': do_kernel_normal_distribution_init,
        'V4.skip': do_kernel_normal_distribution_init,
        'V4.conv1': do_kernel_normal_distribution_init,
    ...
    'CORnet-S_brain2_knall_IT_bi_full': {
        'layers': ['decoder'],
        'V4.conv_input': do_kernel_normal_distribution_init,
        'V4.skip': do_kernel_normal_distribution_init,
        'V4.conv1': do_kernel_normal_distribution_init,
    ...
    'CORnet-S_brain2_t7_t12_knall_IT_bi': {
